...
vim.lsp.config['powershell_es'] = {
    cmd = {'pwsh', '-NoLogo', '-NoProfile', '-ExecutionPolicy', 'Bypass', '-Command',
           "& '/Users/christianpiet/.config/nvim/PowerShellEditorServices/PowerShellEditorServices/Start-EditorServices.ps1'",
           "-BundledModulesPath '/Users/christianpiet/.config/nvim/PowerShellEditorServices'", '-Stdio',
           "-HostName 'nvim'", "-HostProfileId '0'", "-HostVersion '1.0.0'", "-LogLevel 'None'", '-FeatureFlags @()'},
