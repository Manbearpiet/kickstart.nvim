...
-- Add rounded border around windows
...
require('lazy').setup({ -- NOTE: Plugins can be added with a link (or for a github repo: 'owner/repo' link).
  ...
  --     -- TODO: Add mason items instead of relying on it being installed
  --     {
  ...
  --         },
  --       },
  --       -- TODO: uitzoeken met mason of zonder bicep = {},
  --       -- TODO: uitzoeken met paden gh_actions_ls = {},
  --       jsonls = {},
  --       lua_ls = {
  --         -- cmd = { ... },
  --         -- filetypes = { ... },
...
vim.lsp.config['jsonls'] = {
  ...
  cmd = {
    '/opt/homebrew/bin/vscode-json-language-server',
    '--stdio',
  },
}
